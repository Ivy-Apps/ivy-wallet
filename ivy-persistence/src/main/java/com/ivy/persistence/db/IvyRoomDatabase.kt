package com.ivy.persistence.db

import android.content.Context
import androidx.room.*
import androidx.room.migration.AutoMigrationSpec
import com.ivy.core.db.RoomTypeConverters
...
import com.ivy.persistence.db.entity.UserEntity
import com.ivy.core.db.migration.Migration105to106_TrnRecurringRules
import com.ivy.core.db.migration.Migration106to107_Wishlist
import com.ivy.core.db.migration.Migration107to108_Sync
import com.ivy.core.db.migration.Migration108to109_Users
import com.ivy.core.db.migration.Migration109to110_PlannedPayments
import com.ivy.core.db.migration.Migration110to111_PlannedPaymentRule
import com.ivy.core.db.migration.Migration111to112_User_testUser
import com.ivy.core.db.migration.Migration112to113_ExchangeRates
import com.ivy.core.db.migration.Migration113to114_Multi_Currency
import com.ivy.core.db.migration.Migration114to115_Category_Account_Icons
import com.ivy.core.db.migration.Migration115to116_Account_Include_In_Balance
import com.ivy.core.db.migration.Migration116to117_SalteEdgeIntgration
import com.ivy.core.db.migration.Migration117to118_Budgets
import com.ivy.core.db.migration.Migration118to119_Loans
import com.ivy.core.db.migration.Migration119to120_LoanTransactions
import com.ivy.core.db.migration.Migration120to121_DropWishlistItem
import com.ivy.core.db.migration.Migration122to123_ExchangeRates

...
suspend fun balanceChart(
    ...
    @SideEffect
    calcWalletBalance: suspend (com.ivy.base.ClosedTimeRange) -> BigDecimal
...
tailrec suspend fun generateBalanceChart(
    ...
    return if (orderedPeriod.isEmpty()) accumulator else {
        ...
        val chartPoint = ChartPoint(
            range = com.ivy.base.ClosedTimeRange.to(to = toDateTime),
            value = calcWalletBalance(
                com.ivy.base.ClosedTimeRange(
...
tailrec suspend fun generateIncomeExpenseChart(
    orderedPeriod: List<com.ivy.base.ClosedTimeRange>,
    calculateWalletIncomeExpense: suspend (range: com.ivy.base.ClosedTimeRange) -> IncomeExpensePair,
...
tailrec suspend fun generateIncomeExpenseCountChart(
    orderedPeriod: List<com.ivy.base.ClosedTimeRange>,
    calculateWalletIncomeExpenseCount: suspend (range: com.ivy.base.ClosedTimeRange) -> Pair<BigDecimal, BigDecimal>,

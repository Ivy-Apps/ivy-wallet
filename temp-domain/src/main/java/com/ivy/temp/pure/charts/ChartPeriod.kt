...
enum class ChartPeriod {
    ...
    fun toRangesList(): List<com.ivy.base.ClosedTimeRange> {
        return when (this) {
    ...
    private tailrec fun lastNMonths(
        n: Int,
        accumulator: List<com.ivy.base.ClosedTimeRange> = emptyList(),
        endOfMonth: LocalDateTime = endOfMonth(dateNowUTC())
    ): List<com.ivy.base.ClosedTimeRange> {
    ...
    fun xLabel(range: com.ivy.base.ClosedTimeRange): String {
        return when (this) {
            LAST_12_MONTHS -> {

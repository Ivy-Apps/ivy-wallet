    ...
    private suspend fun calculateCategoryAmounts(
        ...
        val catAmtList = allCategories thenMap { category ->
            ...
            CategoryAmount(
                category = category,
                amount = when (type) {
                    TrnTypeOld.INCOME -> catIncomeExpense.income.toDouble()
                    TrnTypeOld.EXPENSE -> catIncomeExpense.expense.toDouble()

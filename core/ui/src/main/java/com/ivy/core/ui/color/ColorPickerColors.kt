...
internal fun colors(): List<Color> = listOf(
    Purple, Purple1, Purple2, Blue, Blue2, Blue3,
    Green, Green2, Green3, Green4, Yellow,
    Orange, Orange2, Orange3, Red, Red2, Red3,
)

internal fun lightColors(): List<Color> = listOf(
...
internal fun darkColors(): List<Color> = listOf(

...
class SyncExchangeRatesUseCaseTest{
    ...
    private val expectedSavedEntities = listOf(
    ...
    fun createDb(){
        ...
        useCase = SyncExchangeRatesUseCase(
            repository
        )
    }
    ...
    @Test
    fun successfulNetworkResponse() = runBlocking {
        successfulNetworkResponseTestCase()
    }

    @Test
    fun unSuccessfulNetworkResponse() = runBlocking {
